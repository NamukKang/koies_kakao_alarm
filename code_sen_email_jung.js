function getFormattedDate() {
  ...
  function sendEmailWithData_for_jung() {
      var ss = SpreadsheetApp.getActiveSpreadsheet();
      var data = ss.getSheetByName("탭이름").getDataRange().getValues();
      var template = HtmlService.createTemplateFromFile('email_template_jung.html');
  ...
  // 예시: 첫 번째 행의 데이터를 공통사항에 반영
      template.content = {
          ...
          total_sum_progress : data[16][2],
          total_sum_over : data[16][4],
          total_sum_predict : data[16][5],
